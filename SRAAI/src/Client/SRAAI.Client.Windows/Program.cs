...
using SRAAI.Client.Core.Components;
using SRAAI.Client.Windows.Services;
using Microsoft.Extensions.Logging;
using Microsoft.AspNetCore.Components.WebView.WindowsForms;
using Velopack.Logging;

namespace SRAAI.Client.Windows;
...
public partial class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "SRAAI.Client.Windows").Build();
