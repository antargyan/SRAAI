using System.IO;
using SRAAI.Shared.Controllers;
using SRAAI.Shared.Controllers.Categories;
using SRAAI.Shared.Controllers.Products;
using SRAAI.Shared.Dtos.Products;

namespace SRAAI.Client.Core.Components.Pages.Products;
