...
namespace SRAAI.Server.Api.Migrations
{
    ...
    [Migration("20250912172239_AddAbhayYojanaApplications")]
    partial class AddAbhayYojanaApplications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Data.AbhayYojanaApplication", b =>
                {
                    b.Property<int>("OriginalSlumNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("OriginalSlumNumber");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OriginalSlumNumber"));
                    ...
                    b.Property<string>("EligibilityStatus")
                        ...
                        .HasColumnName("EligibilityStatus");

                    b.Property<string>("EvidenceDetails")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)")
                        .HasColumnName("EvidenceDetails");

                    b.Property<string>("OriginalSlumDwellerName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("OriginalSlumDwellerName");
                    ...
                    b.Property<string>("SlumUsage")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("SlumUsage");

                    b.Property<DateTime?>("UpdatedDate")
                        .HasColumnType("datetime2")
                        .HasColumnName("UpdatedDate");

                    b.Property<string>("VoterListBound")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("VoterListBound");

                    b.Property<string>("VoterListPartNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("VoterListPartNumber");

                    b.Property<int?>("VoterListSerialNumber")
                        .HasColumnType("int")
                        .HasColumnName("VoterListSerialNumber");

                    b.Property<int?>("VoterListYear")
                        .HasColumnType("int")
                        .HasColumnName("VoterListYear");

                    b.HasKey("OriginalSlumNumber");

                    b.ToTable("AbhayYojanaApplications", "dbo");
                });

            modelBuilder.Entity("SRAAI.Server.Api.Models.Attachments.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Excel.ExcelImportSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<int>("PreviousVersionNo")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DatasetName", "NewVersionNo");

                    b.ToTable("ExcelImportSessions", "dbo");
                });

            modelBuilder.Entity("SRAAI.Server.Api.Models.Excel.ExcelRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("DatasetName", "BusinessKey", "VersionNo");

                    b.ToTable("ExcelRecords", "dbo");
                });

            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.UserToken", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.WebAuthnCredential", b =>
                {
                    b.Property<byte[]>("Id")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = new byte[] { 0, 0, 0, 0, 0, 0, 0, 0 },
                            CreatedOn = new DateTimeOffset(new DateTime(2025, 8, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.PushNotification.PushNotificationSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.RoleClaim", b =>
                {
                    b.HasOne("SRAAI.Server.Api.Models.Identity.Role", "Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Identity.UserClaim", b =>
                {
                    b.HasOne("SRAAI.Server.Api.Models.Identity.User", "User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.Products.Product", b =>
                {
                    b.HasOne("SRAAI.Server.Api.Models.Categories.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("SRAAI.Server.Api.Models.PushNotification.PushNotificationSubscription", b =>
                {
                    b.HasOne("SRAAI.Server.Api.Models.Identity.UserSession", "UserSession")
                        .WithOne("PushNotificationSubscription")
                        .HasForeignKey("SRAAI.Server.Api.Models.PushNotification.PushNotificationSubscription", "UserSessionId")
