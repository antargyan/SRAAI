...
using SRAAI.Server.Api.Controllers;
using SRAAI.Server.Shared.Services;
using SRAAI.Server.Api.Services.Jobs;
using SRAAI.Server.Api.Models.Identity;
using SRAAI.Server.Api.Services.Identity;
using Microsoft.Extensions.Diagnostics.HealthChecks;

namespace SRAAI.Server.Api;
...
public static partial class Program
{
    public static void AddServerApiProjectServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddHangfire(configuration =>
        {
            var efCoreStorage = configuration.UseEFCoreStorage(optionsBuilder =>
            {
                ...
                {
                    var connectionString = "Data Source=SRAAIJobs.db;Mode=Memory;Cache=Shared;";
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "SRAAI.Server.Api.xml"), includeControllerXmlComments: true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "SRAAI.Shared.xml"));
