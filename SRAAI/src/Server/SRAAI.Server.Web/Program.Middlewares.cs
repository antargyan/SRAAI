...
using SRAAI.Shared;
using SRAAI.Shared.Attributes;
using Hangfire;
using SRAAI.Server.Api;
using SRAAI.Server.Api.Filters;
using SRAAI.Server.Api.Services;
using SRAAI.Server.Web.Endpoints;

namespace SRAAI.Server.Web;
...
public static partial class Program
{
    ...
    public static void ConfigureMiddlewares(this WebApplication app)
    {
        ...
        {
            options.InjectJavascript($"/_content/SRAAI.Server.Api/scripts/swagger-utils.js?v={Environment.TickCount64}");
        });
        ...
        var blazorApp = app.MapRazorComponents<Components.App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("SRAAI.Client") is true).ToArray());
