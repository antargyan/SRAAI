...
namespace SRAAI.Server.Web.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/SRAAI.Client.Core");
        ...
        // but uses ../../Client/SRAAI.Client.Web:../../Client/SRAAI.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/SRAAI.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/SRAAI.Client.Maui/Components:../../Client/SRAAI.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/SRAAI.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/SRAAI.Client.Windows/Components:../../Client/SRAAI.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/SRAAI.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/SRAAI.Client.Web/Components:../../Client/SRAAI.Client.Web/Components");
